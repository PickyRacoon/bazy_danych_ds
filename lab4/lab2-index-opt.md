...
Indeks nieklastrowy sprawdza się dobrze dla COUNT(*) z zakresem – odczytuje 2935 stron, a nie aż 14800 jak dla indeksu klastrowego, ale ma dłuższy czas wykonania. Natomiast dla SELECT * z zakresem indeks zostaje zignorowany, bo koszt odwołań do tabeli (żeby zwrócić całe wiersze) po przeszukaniu indeksu byłby wyższy niż Full Table Scan.
